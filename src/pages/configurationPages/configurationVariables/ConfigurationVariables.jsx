...
import { setIdRow, variables } from "../../components/others/table.js";

export default function ConfigurationVariables() {
  // editable variables
  const namePage = "Configuraciones de variables";
  const activeSection = "configuration";
  const activeOption = "Configuraciones de variables";
  const tableName = "Variables";
  const columnNames = ["Nombre", "Activo"];
  const columns = ["nombre", "activo"];
  ...
  const goToAddConfigurationVariable = () => {
    navigate("/configuration/configuration-variables/add/");
  };
  const goToEditConfigurationVariable = (id) => {
    setIdRow(id - 1);
    navigate("/configuration/configuration-variables/edit/");
  };

  const deleteConfigurationVariable = () => {
  ...
  const [totalPages, setTotalPages] = useState(
    Math.ceil(variables?.length / rowsPerPage)
  );
  ...
  const handleInputChange = (event) => {
    ...
    setTotalPages(Math.ceil(variables?.length / parseInt(value)));
  ...
  const filteredData = variables?.slice(startIndex, endIndex);
  if (isLoading) {
              ...
              titleBarButtons={
                <>
                  <button
                    ...
                    onClick={goToAddConfigurationVariable}
                  >
                    ...
                    <div className="formComponent__searchFormContainer">
                      <div className="formComponent__searchInputs">
                        <input
                          ...
                          placeholder="Nombre"
                          title="Introduzca el nombre de la variable que desea buscar"
                        />
                      </div>
                      <button
                            ...
                            <td className="tableComponent__tableContainer__td tableComponent__tableContainer__tdOptions">
                              <div className="tdOptions">
                                <button
                                  ...
                                  title="Editar"
                                  onClick={() =>
                                    goToEditConfigurationVariable(row.id)
                                  }
                                >
                                ...
                                <button
                                  className="tdOptions__button"
                                  title="Borrar"
                                  onClick={() => deleteConfigurationVariable()}
                                >
