...
import { id_row, variables } from "../../components/others/table.js";

export default function EditConfigurationVariables() {
  // editable variables
  const namePage = "Modificar variable";
  const activeSection = "configuration";
  const activeOption = "Configuraciones de variables";
  const i = variables[id_row];
                      ...
                      <div className="formComponent__addInput">
                        ...
                        <label htmlFor="" className="formComponent__addLabel">
                          ...
                          <input
                            ...
                            title="Introduzca si la variable está activa o no"
                          />
                        </label>
                      </div>
