...
import { setIdRow, tipos_horarios } from "../../components/others/table.js";

export default function Schedules() {
  // editable variables
  const namePage = "Horarios";
  const activeSection = "configuration";
  const activeOption = "Horarios";
  const tableName = "Horarios";
  const columnNames = ["Nombre", "Inicio", "Fin", "Activo"];
  const columns = ["nombre", "inicio", "fin", "activo"];
  ...
  const goToAddSchedule = () => {
    navigate("/configuration/schedules/add/");
  };
  const goToEditSchedule = (id) => {
    setIdRow(id - 1);
    navigate("/configuration/schedules/edit/");
  };
  ...
  const [totalPages, setTotalPages] = useState(
    Math.ceil(tipos_horarios?.length / rowsPerPage)
  );
  ...
  const handleInputChange = (event) => {
    ...
    setTotalPages(Math.ceil(tipos_horarios?.length / parseInt(value)));
  ...
  const filteredData = tipos_horarios?.slice(startIndex, endIndex);
  if (isLoading) {
                    ...
                    <div className="formComponent__searchFormContainer">
                      <div className="formComponent__searchInputs">
                        <input
                          ...
                          placeholder="Nombre"
                          title="Introduzca el nombre del horario que desea buscar"
                        />
                      </div>
                      <button
                    ...
                    <div className="formComponent__LabelInputs">
                      <label htmlFor="" className="formComponent__label">
                        ...
                        <input
                          ...
                          placeholder="Digite si el horario es activo o no"
                          title="Introduzca si el horario es activo o no"
                        />
                      </label>
                    </div>
                  </form>
                            ...
                            <td className="tableComponent__tableContainer__td tableComponent__tableContainer__tdOptions">
                              <div className="tdOptions">
                                <button
                                  ...
                                  title="Editar"
                                  onClick={() => goToEditSchedule(row.id)}
                                >
