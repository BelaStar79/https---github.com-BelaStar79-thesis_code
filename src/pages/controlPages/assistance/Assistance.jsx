...
export default function AssistanceControl() {
  // editable variables
  ...
  const columns = ["turno", "posta", "nombre", "estructura", "cantidad"];
  ...
  const [totalPages, setTotalPages] = useState(
    Math.ceil(asistencia?.length / rowsPerPage)
  );
  ...
  const handleInputChange = (event) => {
    ...
    setTotalPages(Math.ceil(asistencia?.length / parseInt(value)));
  ...
  const filteredData = asistencia?.slice(startIndex, endIndex);
  if (isLoading) {
                    ...
                    <div className="formComponent__searchFormContainer">
                      <div className="formComponent__searchInputs">
                        <input
                          ...
                          title="Introduzca el nombre de la zona de guardia"
                        />
                      </div>
                      <button
                            ...
                            <td className="tableComponent__tableContainer__td tableComponent__tableContainer__tdOptions">
                              <div className="tdOptions">
                                <button
                                  ...
                                  title="Editar"
                                  onClick={() => goToEditAssistance(row.id)}
                                >
